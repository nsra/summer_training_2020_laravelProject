                ...
                <div class="card-body">
                    <form action="{{route('service_types.update', $service_type->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="en_title" value="{{ old('en_title', optional($service_type->translate('en'))->title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="ar_title" value="{{ old('ar_title', optional($service_type->translate('ar'))->title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="en_description" >{{ old('en_description', optional($service_type->translate('en'))->description) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="ar_description" >{{ old('ar_description', optional($service_type->translate('ar'))->description) }}</textarea>
