...
Route::get('/projects', ['as' => 'projects.index', 'uses' => 'ProjectsController@index'])->middleware('can:read projects');
Route::post('/projects', ['as' => 'projects.store', 'uses' => 'ProjectsController@store'])->middleware('can:create projects');
Route::get('/projects/create', ['as' => 'projects.create', 'uses' => 'ProjectsController@create'])->middleware('can:create projects');
Route::put('/projects/{project}', ['as' => 'projects.update', 'uses' => 'ProjectsController@update'])->middleware('can:edit projects');
Route::get('/projects/{project}', ['as' => 'projects.show', 'uses' => 'ProjectsController@show'])->middleware('can:read projects');
Route::get('/projects/{project}/edit', ['as' => 'projects.edit', 'uses' => 'ProjectsController@edit'])->middleware('can:edit projects');
